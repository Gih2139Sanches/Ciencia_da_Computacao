-- criar banco de dados - exercício 1
create database fib2022;

-- abrir banco de dados
use fib2022;

-- criar tabela - exercício 2
create table agenda(
...
-- criar tabela exercício 5
-- informações pessoais academicas profissionais
create table alunos(
nome		varchar(40)		not null,
email		varchar(40)		not null,
celular		varchar(20)		null,
...
-- inserir registros
insert into alunos values ('zezao','zezao@gmail.com',null,20,'Ciência da Computação',
2020,'fib','estagiário',1230.89);

-- verificando registros
select * from alunos;

-- criar tabela - exercício 6
