...
insert into agenda values(2,'João','9679467545','20/04/08',1.80);
...
insert into cadastro values('José Amandes','jose_amands@gmail.com','47946',577948600,'02/12/2019','m','998544522');
...
insert into alunos values('José Amandes',22,'m','jose_amands@gmail.com',8,'Ciência Contáveis','contador','senai','60 horas',998754155);
...
insert into produtos values('cereal',245978,'15.20','Tigrão');
insert into produtos values('suco de laranja',587965,'10.5','dell vale');
insert into produtos values('café em pó',245978,'15.20','Forte');
