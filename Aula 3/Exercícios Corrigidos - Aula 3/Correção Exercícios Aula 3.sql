...
-- NAO TEM NA LISTA
-- ATENÇÃO - quando criamos a tabela sem NULL ou NOT NULL
-- o padrão é considerar o campo NULL
...
-- 9 Testar chave primária composta forçando o erro
drop table clientes;
...
-- 15 forçando erro chave primaria com identity
...
-- mínimo 6 em cada tabela – todas as tabelas devem ter chave primária
...
-- nao tem como ter erro de chave primaria na tabela médico e paciente
-- o codigo é identity e é a chave primaria
...
insert into ficha values ('123456789-90','98657234-X','José da Silva Xavier',
